...
import com.helder.SistemaOSmo.api.model.ComentarioInput;
import com.helder.SistemaOSmo.api.model.ComentarioModel;
...
public class ComentarioController {
	...
	public ComentarioModel adicionar(@PathVariable Long ordemServicoId, @Valid @RequestBody ComentarioInput comentarioInput) {
		...
		Comentario comentario = gestaoOrdemServicoService.adicionarComentaro(ordemServicoId, comentarioInput.getDescricao());
